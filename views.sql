...
-- DROP VIEW IF EXISTS Diagnosis_Raw;
-- DROP VIEW IF EXISTS Diagnosis_Report;
-- DROP VIEW IF EXISTS Treatment_Raw
-- DROP VIEW IF EXISTS Treatment_Report;
-- DROP VIEW IF EXISTS Bill_Report;
-- DROP VIEW IF EXISTS Prescription_Report;
